...
namespace Microsoft.BotBuilderSamples
{
    ...
    public class RootDialog : ComponentDialog
    {
            ...
            : base("root")
        {
            ...
            AddDialog(new WaterfallDialog("waterfall", new WaterfallStep[] { StartDialogAsync, FinishDialogAsync, ProcessResultsAsync }));
        ...
        {
            // Start the child dialog. This will run the top slot dialog than will complete when all the properties are gathered.
            await stepContext.Context.SendActivityAsync(MessageFactory.Text("Hola Mundo"), cancellationToken);
            return await stepContext.BeginDialogAsync("slot-dialog", null, cancellationToken);
        }
